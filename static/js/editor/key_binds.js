...
function keybind_copy(edit, _e) {
  if (edit.selected_element) edit.internal_clipboard = edit.selected_element;
}
...
function keybind_paste(edit, _e) {
  read_data_from_clipboard().then((data) => {
    ...
    } else if (/(https?:\/\/.*\.(?:mp4|webm|mkv|avi))(?:\?.*)?$/i.test(data)) {
      // check if it's an video url
      check_dc(data);
      let name = edit.make_unique_element_name('Video');
      edit.add_element(
        new video_element(edit, {
          url: data,
          id,
          name,
          paused: true,
...
function keybind_paste_internal(edit, _e) {
  if (edit.internal_clipboard) {
    ...
    new_element.tf().x += 10;
    new_element.tf().y += 10;
    new_element.data.name = edit.make_unique_element_name(
      new_element.data.name
    );
...
function keybind_delete_selected_element(edit, _e) {
  if (edit.selected_element && edit.current_mode === EDIT_MODE.NONE) {
    ...
    let index = edit.tickable_elements.indexOf(
      edit.elements.get(edit.selected_element.id())
    );
    if (index > -1) edit.tickable_elements.splice(index, 1);
...
function keybind_mirror_selected_element(edit, e) {
  if (edit.selected_element) {
    if (e.shiftKey) edit.selected_element.flip_y();
    else edit.selected_element.flip_x();
...
function keybind_enter_scale_mode(edit, e) {
  if (edit.selected_element && edit.current_mode !== EDIT_MODE.SCALE) {
    ...
    edit.initial_element_size = {
      x: edit.selected_element.tf().scale_x,
      y: edit.selected_element.tf().scale_y,
    };
  }
}
...
function keybind_enter_move_mode(edit, _e) {
  if (edit.selected_element && edit.current_mode !== EDIT_MODE.MOVE) {
    ...
    edit.initial_element_size = {
      x: edit.selected_element.tf().x,
      y: edit.selected_element.tf().y,
    };
  }
}
...
function keybind_enter_rotate_mode(edit, _e) {
  if (edit.selected_element && edit.current_mode !== EDIT_MODE.ROTATE) {
    ...
    edit.initial_element_size = {
      rotation: edit.selected_element.tf().rotation_z,
    };
  }
}
...
const editor_keybinds = [
  ...
  { code: 'KeyF', ctrl: false, function: keybind_favorite_selected_element },
  {
    code: 'KeyH',
    ctrl: false,
    function: keybind_toggle_selected_element_visibility,
  },
